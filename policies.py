...
from common_policies import BasePolicy, register_policy, MlpExtractor
...
class PPOPolicy(BasePolicy):
    ...
    def call(self, obs, deterministic=False):
        ...
        return tf.clip_by_value(action,-1,1), value, log_prob
    ...
    def actor_forward(self, obs, deterministic=False):
        ...
        return tf.stop_gradient(tf.clip_by_value(action,-1,1)).numpy()
